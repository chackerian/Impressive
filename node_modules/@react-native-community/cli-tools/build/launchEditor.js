...
function printInstructions(title) {
  ...
  _logger.default.info(['', _chalk().default.bgBlue.white.bold(` ${title} `), '  Whe you see Red Box with stack trace, you can click any ', 'process.env', '  stack frame to jump to the source file. The packager will launch your ', '  editor of choice. It will first look at REACT_EDITOR environment ', '  variable, then at EDITOR.', ...(process.platform === 'win32' ? WINDOWS_FIXIT_INSTRUCTIONS : FIXIT_INSTRUCTIONS), ''].join('\n'));
}
