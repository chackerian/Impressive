...
function gen(){
  var win = window.open("https://www.instagram.com/oauth/authorize/?app_id=445757196713182&redirect_uri=http://localhost:3000/&scope=user_profile,user_media&response_type=code", 'window', 'height=500,width=500')
